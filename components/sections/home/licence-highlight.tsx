      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <Reveal className="flex flex-col items-stretch gap-8 sm:flex-row sm:items-center">
          <div className="flex shrink-0 flex-col items-center justify-center border border-primary-foreground/20 px-8 py-5">
            <span className="font-display text-6xl leading-none font-medium text-primary-foreground sm:text-7xl">
              {classNumber}
            </span>
          ...
          <div className="flex flex-1 flex-col justify-center gap-3 border-t border-primary-foreground/20 pt-6 sm:border-t-0 sm:border-l sm:pt-0 sm:pl-8">
            ...
            <p className="max-w-2xl text-lg leading-relaxed text-primary-foreground/85">{text}</p>
          </div>
        </Reveal>
      </div>
    </section>
